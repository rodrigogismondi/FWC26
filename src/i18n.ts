...
const strings = {
  en: {
    ...
    mdTabEvents: "Highlights",
    mdTabStats: "Statistics",
    mdTabGroup: "Standings",
    mdClose: "Close",
    mdHalfTime: "HT",
    mdNoEvents: "No goals or cards recorded yet.",
    mdNoStats: "Match statistics not available yet.",
    mdGoal: "Goal · {player}",
  ...
  pt: {
    ...
    thirdSlot: "3º ({groups})",
    mdTabEvents: "Lances",
    mdTabStats: "Estatísticas",
    mdTabGroup: "Classificação",
    mdClose: "Fechar",
    mdHalfTime: "INT",
    mdNoEvents: "Nenhum gol ou cartão registrado ainda.",
    mdNoStats: "Estatísticas do jogo ainda não disponíveis.",
    mdGoal: "Gol · {player}",
